...
def train_model(config):
    ...
    #     initial_epoch=config['preload']+1
    #     checkpoint=torch.load(f"opus_books_weights/epoch_{config['preload']}.pth")
    ...
    for epoch in range(initial_epoch, config['num_epochs']):
        ...
        # torch.save(checkpoint,f"opus_books_weights/epoch_{epoch}.pth")
